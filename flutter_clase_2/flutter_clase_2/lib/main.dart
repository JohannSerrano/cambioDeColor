...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Bomba Explosiva'),
    );
  }
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            children: <Widget>[
              ...
              if (_counter > 0)
                Align(
                  ...
                  child: Image.asset(
                    'assets/imagenes/bomb.png', // Ruta de la imagen de la bomba
      ...
      floatingActionButton: FloatingActionButton(
        ...
        tooltip: 'Incrementar',
        backgroundColor: _isBoom ? Color.fromARGB(255, 174, 88, 18) : null,
